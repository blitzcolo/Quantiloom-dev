...
MAGIC = b'QBAS'
VERSION = 2  # Version 2: per-band n_components
HEADER_SIZE = 64
...
def write_basis_binary(filepath: str,
    ...
    File format v2 (little-endian) - supports per-band basis counts:
        Header (64 bytes):
            - magic: 4 bytes ("QBAS")
            - version: uint32 (2)
            - num_bands: uint32
...
def write_cpp_header(filepath: str,
    ...
    with open(filepath, 'w') as f:
        f.write("// Auto-generated by SpectralBaker\n")
