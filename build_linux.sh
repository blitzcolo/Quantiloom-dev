...
cmake -B out/Release -G "Ninja" -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_COMPILER=g++ -DQUANTILOOM_BUILD_TESTS=OFF -DQUANTILOOM_USE_BC7ENC=ON -DQUANTILOOM_USE_OPENUSD=ON -DUSD_ROOT=/opt/openusd
